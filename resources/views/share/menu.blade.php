    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul>
                    <li> <a href="charts-apex-chart.html"><i class="bx bx-right-arrow-alt"></i>Quản Lý Tài Khoản</a>
                    </li>
                    <li> <a href="charts-chartjs.html"><i class="bx bx-right-arrow-alt"></i>Quản Lý Nhân Viên</a>
                    </li>
                    <li> <a href="/admin/danh-muc/index"><i class="bx bx-right-arrow-alt"></i>Quản Lý Danh Mục</a>
                    </li>
                    <li> <a href="charts-highcharts.html"><i class="bx bx-right-arrow-alt"></i>Quản Lý Hoá Đơn</a>
                    </li>
                    <li> <a href="charts-highcharts.html"><i class="bx bx-right-arrow-alt"></i>Báo Cáo Thống Kê</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <nav class="navbar navbar-expand">
                ...
                <div class="user-box dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" style="background-color: #fff;">
                        <li style="opacity: 1 !important"><a class="dropdown-item" href="javascript:;"><i class="bx bx-user"></i><span>Profile</span></a>
                        </li>
                        <li>
