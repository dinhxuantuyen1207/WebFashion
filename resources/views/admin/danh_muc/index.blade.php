                    ...
                    success: function(res) {
                        $.each(res.data, function(k, v) {
                            ...
                            if (v.ten_danh_muc_cha == null) {
                                ...
                                noidung += '<td class="align-middle text-success">' + v.ten_danh_muc_cha +
                                    '</td>';
                            }
                            if (v.tinh_trang == 1) {
                                noidung +=
                            ...
                            noidung +=
                                '<a href="javascript:;" data-id="'+v.id+'" class="update-danh-muc" data-bs-toggle="modal"data-bs-target="#updateDanhMucModel"><i class="bx bxs-edit"></i></a>';
  ...
  // Chuyển chuỗi sang chữ thường
            ...
            $('body').on('click','.update-danh-muc',function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        $.each(res.danhMucCha, function(k, v) {
                            ndload += '<option value="' + v.id + '">' + v.ten_danh_muc +'</option>';
                        })
