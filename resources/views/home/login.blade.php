                                    ...
                                    <div class="card-body p-md-3 mx-md-2">
                                        ...
                                        <form method="post" action="/">
                                            ...
                                            <div class="form-outline mb-3">
                                                ...
                                                <input type="text" name="tai_khoan" id="tai_khoan" class="form-control"
                                            ...
                                            <div class="text-center pt-1 mb-3 pb-1">
                                                <button id="adminlogin" type="button" class="btn light btn-primary">Đăng Nhập</button>
                                                <p></p>
                                            ...
                                            <div class="d-flex align-items-center justify-content-center pb-1">
                                                ...
                                                <p style="width:2%"></p>
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleScrollableModal">Tạo Tài
                                                    Khoản</button>
                                            </div>
